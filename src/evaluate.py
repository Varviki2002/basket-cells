...
class Evaluate:
    ...
    def absolute_difference(self, cell_name: str, spike: str):
        ...
        abs_1 = np.abs(np.array(self.dict[cell_name][string]) - self.func_1[cell_name][string])
        abs_2 = np.abs(np.array(self.dict[cell_name][string]) - self.func_2[cell_name][string])
        abs_3 = np.abs(np.array(self.dict[cell_name][string]) - self.func_3[cell_name][string])
        abs_4 = np.abs(np.array(self.dict[cell_name][string]) - self.func_4[cell_name][string])
